...
for (const [file, text] of [
  ...
  if (!text.includes("0.7.1")) {
    errors.push(`${file} must include version 0.7.1.`);
  }
...
if (aiJson.packageVersion !== "0.7.1" || aiJson.corePackage?.version !== "0.7.1") {
  errors.push("ai.json package version fields must be 0.7.1.");
}
...
if (
  ...
  sourceCode?.softwareVersion !== "0.7.1" ||
...
if (
  software?.softwareVersion !== "0.7.1" ||
